...
public class TestP10 {
	...
	private static Logger log = Logger.getLogger(TestP10.class);
	...
	public static void main(String[] args) throws Exception {
        ...
        ReqP10Body reqP10Body = new ReqP10Body();
        om.setFilters(CmdContext.getInstance().getFilterProviderByCode("P100101"));
        bodyStr = om.writeValueAsString(reqP10Body);
        message = TestUtil.getCReqMessage("", "00001", bodyStr, "P10", "123456");
        log.info(message);
        content = HttpClientUtil.request(RemoteConfig.IP, RemoteConfig.PORT, RemoteConfig.PATH, message, HttpClientUtil.POST, null);
        log.info(content);

        reqP01Body = new ReqP01Body();
        reqP01Body.setSize(10);
        om.setFilters(CmdContext.getInstance().getFilterProviderByCode("P010101"));
        bodyStr = om.writeValueAsString(reqP01Body);
        message = TestUtil.getCReqMessage("", "00001", bodyStr, "P01", "123456");
