 ...
 *
 */
public class QxcCheckContext {
	
	private static QxcCheckContext context;
	...
	private QxcCheckContext()
	{
		springContext = new FileSystemXmlApplicationContext(new String[]{"classpath:applicationContext-qxc.xml"});
	}
	...
	public static QxcCheckContext getInstance()
	{
		if(context == null)
		{
			context = new QxcCheckContext();
		}
		return context;
	}
