...
public class PlsZhiXuanZuHeDanTuoValidator extends PlsValidator {
	...
	public int validator(String numbers) throws CoreException {
		...
		int count = MathUtil.getC(sCount, PlsConstants.DANSHI_LEN - fCount)*MathUtil.getA(PlsConstants.DANSHI_LEN, PlsConstants.DANSHI_LEN);
		return count;
	}
