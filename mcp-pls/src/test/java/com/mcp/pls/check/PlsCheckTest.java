...
public class PlsCheckTest {
	
	private String drawNumber = "1|7|7";
	
	private String gameCode = "T03";
	...
	{
		Check check = PlsCheckContext.getInstance().getCheckByCode(gameCode + playType + betType);
