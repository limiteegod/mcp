...
@Component("twsDanShiCheck")
public class TwsDanShiCheck extends KtCheck {

    public static Logger log = Logger.getLogger(TwsDanShiCheck.class);
	...
	public CheckParam check(TTicket ticket, String[] number, PrizeDescription prizeDescription)
        ...
        for(int i = 0; i < ticketArray.length; i++)
        {
            ...
            {
                super.getPrizeByLevel(cp, Constants.GRADE_LEVEL_EIGHTEENTH, 1, prizeDescription);
            }
        }
		return cp;
	}
