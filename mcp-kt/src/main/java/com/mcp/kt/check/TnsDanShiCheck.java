...
@Component("tnsDanShiCheck")
public class TnsDanShiCheck extends KtCheck {

    public static Logger log = Logger.getLogger(TnsDanShiCheck.class);
	...
	public CheckParam check(TTicket ticket, String[] number, PrizeDescription prizeDescription)
        ...
        for(int i = 0; i < ticketArray.length; i++)
        {
            ...
            {
                super.getPrizeByLevel(cp, Constants.GRADE_LEVEL_NINETEENTH, 1, prizeDescription);
            }
        }
		return cp;
	}
