 ...
 *
 */
public class EsfCheckContext {
	
	private static EsfCheckContext context;
	...
	private EsfCheckContext()
	{
		springContext = new FileSystemXmlApplicationContext(new String[]{"classpath:applicationContext-esf.xml"});
	}
	...
	public static EsfCheckContext getInstance()
	{
		if(context == null)
		{
			context = new EsfCheckContext();
		}
		return context;
	}
