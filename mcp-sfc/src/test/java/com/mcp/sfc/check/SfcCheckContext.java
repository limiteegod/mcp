 ...
 *
 */
public class SfcCheckContext {
	
	private static SfcCheckContext context;
	...
	private SfcCheckContext()
	{
		springContext = new FileSystemXmlApplicationContext(new String[]{"classpath:applicationContext-sfc.xml"});
	}
	...
	public static SfcCheckContext getInstance()
	{
		if(context == null)
		{
			context = new SfcCheckContext();
		}
		return context;
	}
