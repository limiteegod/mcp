...
import com.mcp.order.inter.jbank.ReqJ08Body;
 ...
 *
 */
public class JBankQueryLastTermHit {
	
	private static Logger log = Logger.getLogger(JBankQueryLastTermHit.class);
	...
	public static void main(String[] args) throws Exception {
		...
		om = new ObjectMapper();
		ReqJ08Body j08body = new ReqJ08Body();
		j08body.setSize(2);
		om.setFilters(CmdContext.getInstance().getFilterProviderByCode("J080101"));
		bodyStr = om.writeValueAsString(j08body);
		message = TestUtil.getReqMessage("", "Q0002", bodyStr, "J08");
		log.info(message);
