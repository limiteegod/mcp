 ...
 *
 */
public class JBankQueryHitHistory {
	
	private static Logger log = Logger.getLogger(JBankQueryHitHistory.class);
	...
	public static void main(String[] args) throws Exception {
		...
		om = new ObjectMapper();
		ReqQ03Body q03body = new ReqQ03Body();
		q03body.setShowTickets(true);
		q03body.setOrderStatus("1810,1900,2100");
		om.setFilters(CmdContext.getInstance().getFilterProviderByCode("Q030101"));
		bodyStr = om.writeValueAsString(q03body);
		message = TestUtil.getReqMessage("", "Q0002", bodyStr, "Q03");
		log.info(message);
