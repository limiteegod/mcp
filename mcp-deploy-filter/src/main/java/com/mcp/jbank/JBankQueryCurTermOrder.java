...
import com.mcp.order.inter.jbank.ReqJ07Body;
 ...
 *
 */
public class JBankQueryCurTermOrder {
	
	private static Logger log = Logger.getLogger(JBankQueryCurTermOrder.class);
	...
	public static void main(String[] args) throws Exception {
		...
		om = new ObjectMapper();
		ReqJ07Body j07body = new ReqJ07Body();
		j07body.setSize(2);
		om.setFilters(CmdContext.getInstance().getFilterProviderByCode("J070101"));
		bodyStr = om.writeValueAsString(j07body);
		message = TestUtil.getReqMessage("", "Q0002", bodyStr, "J07");
		log.info(message);
