...
public class ZeFsValidator extends KptValidator {

    public static Logger log = Logger.getLogger(ZeFsValidator.class);


    @Override
    public int validator(String numbers) throws CoreException {
        if(!numbers.matches("^\\d{2}(,\\d{2}){2,12}$"))
        {
        ...
        return MathUtil.getC(numIntArray.length, 2);
    }
