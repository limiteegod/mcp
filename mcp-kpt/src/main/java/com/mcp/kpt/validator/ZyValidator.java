...
public class ZyValidator extends KptValidator {

    public static Logger log = Logger.getLogger(ZyValidator.class);


    @Override
    public int validator(String numbers) throws CoreException {
        if(!numbers.matches("^\\d{2}(,\\d{2}){0,12}$"))
        {
