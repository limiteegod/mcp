...
public class ZlFsValidator extends KptValidator {

    public static Logger log = Logger.getLogger(ZlFsValidator.class);


    @Override
    public int validator(String numbers) throws CoreException {
        if(!numbers.matches("^\\d{2}(,\\d{2}){6,12}$"))
        {
        ...
        return MathUtil.getC(numIntArray.length, 6);
    }
