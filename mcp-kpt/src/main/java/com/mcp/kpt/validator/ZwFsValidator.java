...
public class ZwFsValidator extends KptValidator {

    public static Logger log = Logger.getLogger(ZwFsValidator.class);


    @Override
    public int validator(String numbers) throws CoreException {
        if(!numbers.matches("^\\d{2}(,\\d{2}){5,12}$"))
        {
        ...
        return MathUtil.getC(numIntArray.length, 5);
    }
