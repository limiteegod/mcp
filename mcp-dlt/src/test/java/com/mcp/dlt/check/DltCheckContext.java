 ...
 *
 */
public class DltCheckContext {
	
	private static DltCheckContext context;
	...
	private DltCheckContext()
	{
		springContext = new FileSystemXmlApplicationContext(new String[]{"classpath:applicationContext-dlt.xml"});
	}
	...
	public static DltCheckContext getInstance()
	{
		if(context == null)
		{
			context = new DltCheckContext();
		}
		return context;
	}
