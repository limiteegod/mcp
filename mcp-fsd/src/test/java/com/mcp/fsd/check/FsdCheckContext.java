 ...
 *
 */
public class FsdCheckContext {
	
	private static FsdCheckContext context;
	...
	private FsdCheckContext()
	{
		springContext = new FileSystemXmlApplicationContext(new String[]{"classpath:applicationContext-fsd.xml"});
	}
	...
	public static FsdCheckContext getInstance()
	{
		if(context == null)
		{
			context = new FsdCheckContext();
		}
		return context;
	}
